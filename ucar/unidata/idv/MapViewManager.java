...
public class MapViewManager extends NavigatedViewManager {
    ...
    protected void addPropertiesComponents(JTabbedPane tabbedPane) {
        ...
        if ( !useGlobeDisplay) {
            ...
            // don't mess with status of the latlonScaleInfo visibility here-
            // this lets the checkboxes reflect the current status of each
            // axis's visibility, independent of master 'show display scales' switch
            //mpDisplay.getLatScaleInfo().setVisible(true);
            //mpDisplay.getLonScaleInfo().setVisible(true);
